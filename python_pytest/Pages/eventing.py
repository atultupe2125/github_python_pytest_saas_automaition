...
# Write the complete element selector here for this Text Case
    ...
    link_select_element = (By.XPATH, "//normalize-space()='Art']")
    ...
    def do_event_load(self,typ):
        ...
        #
        # select the link "retail.acoustic-demo.com" from RHS of event composer screen
        time.sleep(5)
        interaction_type = self.driver.execute_script(
            """return document.querySelector('#div-right-panel').shadowRoot.querySelector('#hostname > p.bx--typography-text__productive-heading-02.button-value')""")
        ...
        time.sleep(2)
        if typ == "CB":
            event_name.send_keys("CB_ScreenView")
        elif typ == "simple event":
            rnd_num = random.randint(0, 30)
            event_name.send_keys("ALT_Test_Events_Interaction_load" + str(rnd_num))
    ...
    def do_event_page_data(self):
        ...
        # select the page_data interaction type
        time.sleep(5)
        interaction_type = self.driver.execute_script(
            """return document.querySelector('#extension_entry').shadowRoot.querySelector('#interactionType > div > div.styles-module_dropdown-event_eQQ3zHzy.aco--dropdown.aco--dropdown--open > span > div.aco--dropdown__menu > div > div:nth-child(5) > div > div')""")
        interaction_type.click()

        # Click on element selector Load page data
        time.sleep(5)
        element_selector_click = self.driver.execute_script(
            """return document.querySelector('#extension_entry').shadowRoot.querySelector('#acoustic-left-panel > div > div > form > div > div:nth-child(2) > div.styles-module_event-selector-button_R6_8WMX3 > button')""")
        element_selector_click.click()


        # select the link page title from Datalayer from RHS of event composer screen
        time.sleep(5)
        interaction_type = self.driver.execute_script(
            """return document.querySelector('#div-right-panel').shadowRoot.querySelector('#acoustic-elements-div > div.json-code-visor > div > div > div > div > div > div > div > div:nth-child(1) > div > div > div:nth-child(1) > div > div > div:nth-child(3) > span:nth-child(1) > span.object-key > span:nth-child(2)')""")

        interaction_type.click()

        time.sleep(10)
        #Point(x=1313, y=306)
        pyautogui.moveTo(1313, 306)
        time.sleep(2)
        pyautogui.click(1313, 306)
        ...
        time.sleep(2)
        rnd_num = random.randint(0, 30)
        event_name.send_keys("ALT_Test_Events_Interaction_page_data_" + str(rnd_num))
    ...
    def do_event_click_for_a2c(self):
        ...
        # click on the Add to Cart button is click hyperlink
        time.sleep(5)
        ...
        time.sleep(2)
        rnd_num = random.randint(0, 30)
        event_name.send_keys("CB_Add_To_Cart_Button")
    ...
    #Below function will be common to create the Text event
    def do_event_text_event_for_a2c(self,xpath,event_nm):
        # below is to click on Event Composer UI -> Create Event Button
        event = self.driver.execute_script(
            """return document.querySelector('#extension_entry').shadowRoot.querySelector('#landing-page > div:nth-child(3) > div > div > p.bx--typography-text__body-long-01')""")
        event.click()
        ...
        # click on the Text for product id selection
        time.sleep(5)
        ...
        #//h1[normalize-space()='CRUX® ARTISAN SERIES 5-CUP COFFEE MAKER']
