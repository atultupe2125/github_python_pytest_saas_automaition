...
class Test_event_click_creation(BaseTest):
    try:
        ...
        def test_click_eventing(self):
            ...
            #pass the product id xapth to method in event class
            product_id = "//li[contains(text(), 'Product Code: CRUX® ARTISAN SERIES 5-CUP COFFEE MA')]"
            event_name="CB_Product_id"
